...
//Problem Statement
//Given an integer array A of size N. The array is Good if the GCD 
//(Greatest Common Divisor) of all elements of array is a multiple of 2.
//You need to make the array Good. You can perform only increment operations
//(if the array value is A[i] make it A[i]+1) on array elements.
